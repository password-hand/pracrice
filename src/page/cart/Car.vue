<template>
    <div class="car-box">
        <header >购物车</header>
        <!-- 没有数据情况 -->
        <div class="content" v-show="addGoods">
            <div class="txt">
        ...
        <!-- 有数据的情况 -->
        <div v-show="!addGoods" class="shopList">
            <!--编辑商品  -->
            <div class="compile-goods">
                ...
                <ul class="compile-content">
                    <li class="clearfix" v-for="(book,index) in shopCarBook" :key="book.id">
                        <!-- 左边图片盒子 -->
            ...
            <transition name="fade">
                <div class="delete-goods" v-show="changeChoose">
                    ...
                    <div class="delete-box">
                        <div class="delete-content clearfix" v-for="(goods,index) in shopCarBook" :key="goods.id">
